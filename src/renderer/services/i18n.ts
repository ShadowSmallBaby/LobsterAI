...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    authRuntimeInitializing: '正在初始化模型…',
    authRuntimeFailed: '模型初始化失败，请重试',
    authRuntimeRetry: '重试',
    authFreeLabel: 'Free',
  ...
  en: {
    ...
    authRuntimeInitializing: 'Initializing models…',
    authRuntimeFailed: 'Model initialization failed. Please retry.',
    authRuntimeRetry: 'Retry',
    authFreeLabel: 'Free',
